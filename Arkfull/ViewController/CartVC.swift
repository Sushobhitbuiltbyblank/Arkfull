...
class CartVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let reuseIdentifier = "cartTVCell"
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.registerNib(UINib(nibName: "CartTVCell", bundle: nil), forCellReuseIdentifier: reuseIdentifier)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = self.tableView.dequeueReusableCellWithIdentifier(reuseIdentifier, forIndexPath: indexPath) as! CartTVCell
